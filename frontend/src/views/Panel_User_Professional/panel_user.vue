          ...
          <div class="bg-white rounded-lg shadow-sm">
            ...
            <div v-else-if="activeSection === 'schedule'" class="p-6">
              ...
              <div v-if="!hasActivePlan" class="text-center py-12">
                ...
                <p class="text-gray-600 mb-6">
                  Crea horarios personalizados, gestiona múltiples consultorios y automatiza tu agenda.
                </p>
                <button 
                  @click="upgradeSubscription"
              ...
              <div v-else>
                <p class="text-gray-600">Funcionalidad de horarios completa aquí...</p>
              </div>
            </div>
            ...
            <div v-else-if="activeSection === 'appointments'" class="p-6">
              ...
              <div v-if="!hasActivePlan" class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
                <p class="text-amber-800 text-sm">
                  <strong>Modo limitado:</strong> Puedes ver tus citas pero no crear nuevas o usar funcionalidades avanzadas.
                </p>
              </div>
            ...
            <div v-else-if="activeSection === 'patients'" class="p-6">
              ...
              <div v-if="!hasActivePlan" class="text-center py-12">
                ...
                <p class="text-gray-600 mb-6">
                  Mantén un registro completo de todos tus pacientes con historiales médicos.
                </p>
                <button 
                  @click="upgradeSubscription"
                  class="bg-[var(--blue-1)] text-white px-8 py-3 rounded-lg hover:bg-blue-600 transition-colors text-lg font-medium">
            ...
            <div v-else-if="activeSection === 'reports'" class="p-6">
              ...
              <div v-if="!hasActivePlan" class="text-center py-12">
                ...
                <p class="text-gray-600 mb-6">
                  Accede a estadísticas detalladas, reportes financieros y análisis de rendimiento.
                </p>
                <button 
                  @click="upgradeSubscription"
                  class="bg-[var(--blue-1)] text-white px-8 py-3 rounded-lg hover:bg-blue-600 transition-colors text-lg font-medium">
              ...
              <div v-else>
                <p class="text-gray-600">Funcionalidad de reportes completa aquí...</p>
              </div>
            </div>
                ...
                <div class="border rounded-lg p-4">
                  <div class="flex items-start">
                    ...
                    <div>
                      ...
                      <p class="text-sm text-gray-600">Juan Pérez agendó una cita para mañana</p>
                  ...
                  <div class="flex items-center justify-between">
                    <div>
                      ...
                      <p class="text-sm text-gray-600">
                        {{ hasActivePlan ? 'Acceso completo a todas las funcionalidades' : 'Acceso limitado' }}
                      </p>
                    </div>
                    <button 
                      v-if="!hasActivePlan"
